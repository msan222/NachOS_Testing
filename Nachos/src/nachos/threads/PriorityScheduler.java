...
public class PriorityScheduler extends Scheduler {
		...
		if(this.HoldingQueues.isEmpty()) {
			...
			while(TPQueueNT.hasNext()){
				...
				for(int i=0; i<size;i++) {
					int eff = HoldResource.WaitingTSQueue.size();
					if(max<eff)
						max = eff;
				}
	 ...
	 */
	public void waitForAccess(ThreadPriorityQueue threadPriorityQueue) {
	    // implement me
	}
	 ...
	 */
	public void acquire(ThreadPriorityQueue threadPriorityQueue) {
	    // implement me
	}	
